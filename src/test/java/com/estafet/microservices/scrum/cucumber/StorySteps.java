...
public class StorySteps {
    ...
    public void i_click_Add_Story_from_the_project_page(String project) throws Throwable {
    ...
    public void enter_a_title_of(String arg1) throws Throwable {
    ...
    public void i_should_be_able_to_click_on_the_link_for_story_navigate_to_the_story_page(String arg1) throws Throwable {
        storyPage = projectPage.clickStoryLink(arg1);
        assertTrue(storyPage.isLoaded());
    }

    @Then("^which should have a status of \"([^\"]*)\"$")
    public void which_should_have_a_status_of(String arg1) throws Throwable {
        assertThat(storyPage.getStatus(), is(arg1));
    }

    @Then("^a title of \"([^\"]*)\"$")
    public void a_title_of(String arg1) throws Throwable {
        assertThat(storyPage.getName(), is(arg1));
    }

    @Then("^story points of (\\d+)$")
    public void story_points_of(int arg1) throws Throwable {
